...
export function FileTree({
  ...
  return (
    <div className="flex h-full w-48 shrink-0 flex-col border-r border-neutral-800 bg-neutral-950">
      <div className="flex items-center justify-between px-3 py-2.5">
        ...
        <button
          ...
          onClick={onNewPage}
          title="New file"
          className="grid h-5 w-5 place-items-center rounded text-neutral-500 transition-colors hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
        >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-1.5 pb-2">
        {pages.map((page) => {
          ...
          return (
            ...
            >
              <FileCode2 className="h-3.5 w-3.5 shrink-0 text-neutral-500" />
              {isRenaming ? (
                <input
                  autoFocus
                  value={draft}
                  ...
                  className="min-w-0 flex-1 rounded bg-black/40 px-1 py-0.5 font-mono text-[12px] text-white outline-none ring-1 ring-white/20"
                />
              ) : (
                <button
                  type="button"
