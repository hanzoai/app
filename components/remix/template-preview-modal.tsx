...
export function TemplatePreviewModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl overflow-hidden border-white/10 bg-neutral-950 p-0 text-white">
        ...
        {/* Preview body */}
        <div className="p-5">
          <div className="relative aspect-[16/9] overflow-hidden rounded-lg border border-white/10 bg-neutral-900">
            {item.hasImage ? (
          ...
          <div className="mt-4 flex items-start justify-between gap-4">
            ...
            {item.previewUrl && (
              <a
                ...
                className="inline-flex shrink-0 items-center gap-1 text-xs text-white/40 transition-colors hover:text-white"
              >
                Live preview
