...
export function createBaseItems(store: IRootStore) {
  let items: Item[] = [
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 p-0.5 rounded items-center bg-black">
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 p-0.5 rounded items-end bg-black">
            <div className="w-3 h-5 rounded-sm bg-white" />
          </div>
        )
      },
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 p-0.5 rounded items-start bg-black">
            <div className="w-[50%] h-5 rounded-sm bg-white" />
          </div>
        )
      },
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 p-0.5 rounded items-start bg-black">
            <div className="w-5 h-[50%] rounded-sm bg-white" />
          </div>
        )
      },
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 p-0.5 rounded justify-end bg-black">
            <div className="w-5 h-[50%] rounded-sm bg-white" />
          </div>
        )
      },
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 p-0.5 rounded items-start bg-black">
            <div className="w-1 h-1 p-1 rounded-sm bg-white" />
          </div>
        )
      },
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 p-0.5 rounded items-start justify-end bg-black">
            <div className="w-1 h-1 p-1 rounded-sm bg-white" />
          </div>
        )
      },
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 p-0.5 rounded items-end justify-end bg-black">
            <div className="w-1 h-1 p-1 rounded-sm bg-white" />
          </div>
        )
      },
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 rounded items-center justify-center bg-black">
    ...
    },
    {
      ...
      IconComponent: () => {
        return (
          <div className="w-6 h-6 p-0.5 rounded items-center justify-center bg-black">
            <div className="w-1 h-1 p-1 rounded-sm bg-white" />
          </div>
        )
      },
