...
6.  Save the file.
7.  Start Claude. Your Hanzo server should now be available.
...
4.  Save the file.
5.  **Restart Cursor**. Your Hanzo server should now be available.
...
4.  Save the file.
5.  **Restart Cursor**. Your Hanzo server should now be available via SSE.
