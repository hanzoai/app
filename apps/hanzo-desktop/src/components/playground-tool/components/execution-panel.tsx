  ...
  function processLogLines(lines: string[]) {
    return lines
      .filter((line) => {
        ...
        if (/<\/?hanzo-code-result>/.test(line)) return false;
