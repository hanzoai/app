...
description: Understand where Hanzo AI stores your data and how to monitor server logs.
keywords:
  [
    Hanzo AI,
    local AI,
...
Hanzo AI stores all your data locally on your computer. No cloud storage, no external servers - everything stays on your machine.

## Quick Access

**Via Hanzo AI Interface:**
...
~/.config/Hanzo AI/data

# Custom installation
$XDG_CONFIG_HOME/Hanzo AI/data
```
</Tabs.Tab>
</Tabs>
...
When Hanzo AI's local server is running, you can monitor real-time activity in the logs folder:
...
**Accessing logs:**
- **In Hanzo AI**: System Monitor (footer) > App Log
...
**File permissions:**
- Only you and Hanzo AI can access these files
- Standard user-level permissions
- No elevated access required

<Callout type="info">
When using cloud AI services through Hanzo AI, those conversations follow the cloud provider's data policies. Local model conversations never leave your computer.
</Callout>

## Common Tasks

### Backup Your Data
Copy the entire Hanzo AI data folder to backup:
- All chat history
...
### Clear Chat History
Delete individual thread folders in `/threads/` or use Hanzo AI's interface to delete conversations.
...
4. Restart Hanzo AI if files appear corrupted

## Uninstalling Hanzo AI

If you need to completely remove Hanzo AI and all data:

**Keep data (reinstall later):** Just uninstall the application
**Remove everything:** Delete the Hanzo AI data folder after uninstalling

Detailed uninstall guides:
- [macOS](/docs/desktop/mac#step-2-clean-up-data-optional)
- [Windows](/docs/desktop/windows#step-2-handle-hanzo-data)
- [Linux](/docs/desktop/linux#uninstall-hanzo)
