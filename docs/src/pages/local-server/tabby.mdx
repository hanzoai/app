---
title: Tabby
description: A step-by-step guide on integrating Hanzo AI with Tabby and VSCode, JetBrains, or other IDEs.
keywords:
  [
    Hanzo AI,
...
## Integrate Hanzo AI with Tabby and Your Favorite IDEs
...
and it can be used with various LLM services, including Hanzo AI.

To integrate Hanzo AI with Tabby, follow these steps:

<Steps>

### Step 1: Enable the Hanzo AI API Server

To set up Tabby with Hanzo AI's Local Server, you must activate the Hanzo AI API Server with your chosen model.

1. Click the `Local API Server` (`<>`) button above the Settings. Hanzo AI will direct you to the **Local API Server** section.
...
Then, follow the steps to connect Hanzo AI with the Tabby server:
[Connect Hanzo AI with Tabby](https://tabby.tabbyml.com/docs/references/models-http-api/hanzo.ai/).

For example, to connect Hanzo AI with Tabby, save the following configuration under `~/.tabby/config.toml`:
...
Currently, the Hanzo AI completion and embedding API is under construction.
Once completed, you can also connect Hanzo AI with Tabby for completion and embedding tasks.
...
## How to Use Tabby with Hanzo AI Integration
...
which can leverage the Hanzo AI LLM and related contexts like code, documentation, and web pages to answer user questions.

Simply open the Tabby homepage at [localhost:8080](http://localhost:8080) and ask your questions.

### IDE Chat Sidebar

After installing the Tabby extension on your preferred IDEs, you can engage in a conversation with Hanzo AI to:

1. Discuss your code, receive suggestions, and seek assistance.
2. Request Hanzo AI to inline edit your code, and then review and accept the proposed changes.