---
title: Settings
description: Configure Hanzo AI to work best for your needs and hardware.
keywords:
  [
    Hanzo AI,
    settings,
...
Access Hanzo AI's settings by clicking the <Settings width={16} height={16} style={{display:"inline"}}/> icon in the bottom left corner.
...
Customize Hanzo AI's look at **Settings** > **Appearance**:
...
**Spell Check:** Hanzo AI can help catch typing mistakes in your messages.
...
**Optional: Help improve Hanzo AI**
...
Hanzo AI stores everything locally on your computer in standard file formats.

**Access Your Data:**
- Click the folder icon to open Hanzo AI's data directory
...
4. Restart Hanzo AI to complete the change
...
**What it does:** Returns Hanzo AI to its original state - deletes everything.
