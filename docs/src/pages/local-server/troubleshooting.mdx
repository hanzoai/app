...
description: Fix common issues and optimize Hanzo AI's performance with this comprehensive guide.
keywords:
  [
    Hanzo AI,
    troubleshooting,
...
When Hanzo AI isn't working properly, error logs help identify the problem. Here's how to get them:

### Quick Access to Logs

**In Hanzo AI Interface:**
...
# Windows  
type %APPDATA%\Hanzo AI\data\logs\app.log
```
...
### Hanzo AI Won't Start (Broken Installation)

If Hanzo AI gets stuck after installation or won't start properly:
...
1. **Uninstall Hanzo AI** from Applications folder

2. **Delete all Hanzo AI data:**
```bash
...
4. **Download fresh copy** from [hanzo.ai](/download)
...
1. **Uninstall Hanzo AI** via Control Panel
...
```bash
# Default location
rm -rf ~/.config/Hanzo AI

# Or custom location
rm -rf $XDG_CONFIG_HOME/Hanzo AI
```
...
<Callout type="info">
Make sure Hanzo AI is completely removed from all user accounts before reinstalling.
</Callout>

### NVIDIA GPU Not Working

If Hanzo AI isn't using your NVIDIA graphics card for acceleration:
...
### Step 2: Enable GPU Acceleration in Hanzo AI
...
Close and restart Hanzo AI to apply changes.
...
**5. Clean Reinstall**
If problems persist, do a complete clean installation (see "Hanzo AI Won't Start" section above).
...
- Post in the **#🆘|hanzo-help** channel
