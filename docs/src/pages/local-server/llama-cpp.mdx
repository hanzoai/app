...
description: Configure Hanzo AI's local AI engine for optimal performance.
keywords:
  [
    Hanzo AI,
    local AI,
...
llama.cpp is the engine that runs AI models locally on your computer. It's what makes Hanzo AI work without needing internet or cloud services.
...
<Callout type="info">
Most users don't need to change these settings. Hanzo AI picks good defaults for your hardware automatically.
</Callout>
