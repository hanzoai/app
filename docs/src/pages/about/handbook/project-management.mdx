...
description: Project management at Hanzo AI
keywords:
  [
    Hanzo AI,
...
We use the [Hanzo AI Monorepo Project](https://github.com/orgs/hanzoai/projects/5) in Github to manage our roadmap and sprint Kanbans.
...
- [High-level roadmap](https://github.com/orgs/hanzoai/projects/5/views/16): view used at at strategic level, for team wide alignment. Start & end dates reflect engineering implementation cycles. Typically product & design work preceeds these timelines.
- [Standup Kanban](https://github.com/orgs/hanzoai/projects/5/views/25): view used during daily standup. Sprints should be up to date.

## Organization

[`Roadmap Labels`](https://github.com/hanzoai/hanzo/labels?q=roadmap)

- `Roadmap Labels` tag large, long-term, & strategic projects that can span multiple teams and multiple sprints
- Example label: `roadmap: Hanzo AI has Mobile`
- `Roadmaps` contain `epics`

[`Epics`](https://github.com/hanzoai/hanzo/issues?q=is%3Aissue+is%3Aopen+label%3A%22type%3A+epic%22)
...
[`Milestones`](https://github.com/hanzoai/hanzo/milestones)
...
[`Tasks`](https://github.com/hanzoai/hanzo/issues)
...
We aim to always sprint on `tasks` that are a part of the [current roadmap](https://github.com/orgs/hanzoai/projects/5/views/16).
...
We'd appreciate high quality insights and volunteers for user interviews through [Discord](https://discord.gg/af6SaTdzpx) and [Github](https://github.com/hanzoai).
