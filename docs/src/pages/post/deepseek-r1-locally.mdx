...
tags: DeepSeek, R1, local AI, Hanzo AI, GGUF, Qwen, Llama
categories: guides
date: 2025-01-31
ogImage: assets/deepseek-r1-locally-hanzo.jpg
twitter:
  card: summary_large_image
  site: "@hanzodotai"
  title: "Run DeepSeek R1 locally on your device (Beginner-Friendly Guide)"
  description: "A straightforward guide to running DeepSeek R1 locally regardless of your background."
  image: assets/deepseek-r1-locally-hanzo.jpg
---
...
![DeepSeek R1 running locally in Hanzo AI AI interface, showing the chat interface and model settings](./_assets/deepseek-r1-locally-hanzo.jpg)
...
## Step 1: Download Hanzo AI
[Hanzo AI](https://hanzo.ai/) is an open-source application that enables you to run AI models locally. It's available for Windows, Mac, and Linux. For beginners, Hanzo AI is the best choice to get started.

![Hanzo AI AI interface, showing the download button](./_assets/download-hanzo.jpg)

1. Visit [hanzo.ai](https://hanzo.ai)
...
Launch Hanzo AI and navigate to Hanzo AI Hub using the sidebar

![Hanzo AI AI interface, showing the model library](./_assets/hanzo-library-deepseek-r1.jpg)

3. Input the model link in this field:

![Hanzo AI AI interface, showing the model link input field](./_assets/hanzo-hub-deepseek-r1.jpg)
...
![Hanzo AI interface, showing DeepSeek R1 running locally](./_assets/hanzo-runs-deepseek-r1-distills.jpg)
