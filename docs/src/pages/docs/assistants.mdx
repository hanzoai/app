...
Hanzo AI allows you to give models specific sets of instructions without having to repeat yourself. We called these
...
1. Open Hanzo AI and look at the left sidebar.
...
Hanzo AI to your needs in real time.
