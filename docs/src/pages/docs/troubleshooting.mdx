...
description: Explore solutions for common issues and optimize Hanzo AI's performance with this comprehensive troubleshooting guide.
keywords:
  [
    Hanzo AI,
...
Error logs are essential for troubleshooting issues and getting help from Hanzo AI team. To get error logs from Hanzo AI, follow the steps below:

#### Through Hanzo AI Interface
...
**Application Logs**
```bash
tail -n 50 ~/Library/Application\ Support/Hanzo AI/data/logs/app.log
```
**Server Logs**
```bash
tail -n 50 ~/Library/Application\ Support/Hanzo AI/data/logs/cortex.log
```
...
To resolve the issue where Hanzo AI is stuck in a broken build after installation:

<Tabs items={['Mac', 'Windows', 'Linux']}>
  <Tabs.Tab>
      1. **Uninstall** Hanzo AI

      2. **Delete** Application Data, Cache, and User Data:

      ```zsh
      rm -rf ~/Library/Application\ Support/Hanzo AI
      ```
      ...
      4. **Download** the [latest version of Hanzo AI](/download)
  </Tabs.Tab>

  <Tabs.Tab>
      1. **Uninstall** Hanzo AI, using the [Windows Control Panel](https://support.microsoft.com/en-us/windows/uninstall-or-remove-apps-and-programs-in-windows-4b55f974-2cc6-2d2b-d092-5905080eaf98)
  ...
  <Tabs.Tab>
      ...
      Choose the appropriate method based on how you installed Hanzo AI:

      **For Debian/Ubuntu:**
      ```
      sudo apt-get remove Hanzo AI
      ```
      **For Others:** Delete the Hanzo AI `.AppImage` file from your system
      ...
      $XDG_CONFIG_HOME = /home/username/custom_config/Hanzo AI
      ```
...
Following these steps, you can cleanly uninstall and reinstall Hanzo AI, ensuring a smooth and error-free experience with the latest version.

<Callout type="info">
  Before reinstalling Hanzo AI, ensure it's completely removed from all shared spaces if installed on multiple user accounts on your device.
</Callout>

## Troubleshooting NVIDIA GPU
To resolve issues when Hanzo AI does not utilize the NVIDIA GPU on Windows and Linux systems.
...
Hanzo AI manages GPU usage automatically:
...
3. Verify your selected GPU(s) are visible in **System Monitor** from Hanzo AI's footer
...
### Step 4: Restart Hanzo AI

Restart Hanzo AI to make sure it works.

</Steps>

### Tested Configurations
These configurations have been verified to work with Hanzo AI's GPU acceleration. You can use them as reference points for your setup.
...
When running Hanzo AI, you might encounter the following error message:

```
Uncaught (in promise) Error: Error invoking layout-480796bff433a3a3.js:538 remote method 'installExtension':
Error Package /Applications/Hanzo AI.app/Contents/Resources/app.asar.unpacked/pre-install/hanzohq-assistant-extension-1.0.0.tgz does not contain a valid manifest:
...
This command ensures that the necessary permissions are granted for Hanzo AI's installation.
...
Default Hanzo AI ports:
- Hanzo AI and Cortex API Server: `1337`
- Hanzo AI Documentation: `3001`

**4. Factory Reset**

A factory reset can resolve persistent issues by returning Hanzo AI to its original state. This will remove all custom settings, downloaded models, and chat history.
...
- Uninstall Hanzo AI & clean Hanzo AI data folders ([Mac](/docs/desktop/mac#uninstall-hanzo), [Windows](/docs/desktop/windows#uninstall-hanzo), [Linux](docs/desktop/linux#uninstall-hanzo))
- Install the latest [stable release](/download)

<Callout type="warning">
This will delete all your Hanzo AI data.
</Callout>
...
- Go to our [Discord](https://discord.com/invite/FTk2MvZwJH) & send it to **#🆘|hanzo-help** channel for further support.
