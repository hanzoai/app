...
### Step 1: Install Hanzo AI

1. [Download Hanzo AI](/download)
2. Install the app ([Mac](/docs/desktop/mac), [Windows](/docs/desktop/windows), [Linux](/docs/desktop/linux))
3. Launch Hanzo AI

### Step 2: Download a Model

Hanzo AI requires a model to chat. Download one from the Hub:
...
Hanzo AI organizes conversations into threads for easy tracking and revisiting.
