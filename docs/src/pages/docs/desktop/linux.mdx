---
title: Linux
description: Get started quickly with Hanzo AI, an AI chat application that runs 100% offline on your desktop & mobile (*coming soon*).
keywords:
  [
    Hanzo AI,
...
# Linux Installation
Instructions for installing Hanzo AI on Linux.
...
<Tabs.Tab>
Stable release:
  - Ubuntu: [hanzo.deb](https://app.hanzo.ai/download/latest/linux-amd64-deb)
  - Others: [Hanzo AI.AppImage](https://app.hanzo.ai/download/latest/linux-amd64-appimage)
...
Beta release:
  - Ubuntu: [hanzo.deb](https://app.hanzo.ai/download/beta/linux-amd64-deb)
  - Others: [Hanzo AI.AppImage](https://app.hanzo.ai/download/beta/linux-amd64-appimage)
...
Development build:
 - Ubuntu: [hanzo.deb](https://app.hanzo.ai/download/nightly/linux-amd64-deb)
 - Others: [Hanzo AI.AppImage](https://app.hanzo.ai/download/nightly/linux-amd64-appimage)
...
```bash
sudo dpkg -i hanzo-linux-amd64-{version}.deb
```

##### apt-get

```bash
sudo apt-get install ./hanzo-linux-amd64-{version}.deb
```
...
```bash
chmod +x hanzo-linux-x86_64-{version}.AppImage
./hanzo-linux-x86_64-{version}.AppImage
```
...
rm -rf Hanzo AI
rm -rf ~/.config/Hanzo AI/data
rm -rf ~/.config/Hanzo AI/cache
```
</Tabs.Tab>
<Tabs.Tab>

```bash
rm hanzo-linux-x86_64-{version}.AppImage
