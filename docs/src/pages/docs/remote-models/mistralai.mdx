...
description: A step-by-step guide on integrating Hanzo AI with Mistral AI.
keywords:
  [
    Hanzo AI,
...
Hanzo AI supports all models available via the [Mistral AI](https://mistral.ai/) API, allowing you to use Mistral's
powerful models (Mistral Large, Mistral Medium, Mistral Small and more) through Hanzo AI's interface.

## Integrate Mistral AI with Hanzo AI
...
Hanzo AI automatically includes Mistral's available models. In case you want to use a specific Mistral model
that you cannot find in **Hanzo AI**, follow the instructions in [Add Cloud Models](/docs/manage-models#add-models-1):
...
- Look for error messages in [Hanzo AI's logs](/docs/troubleshooting#how-to-get-error-logs)
