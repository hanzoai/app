---
title: OpenRouter
description: A step-by-step guide on integrating Hanzo AI with OpenRouter.
keywords:
  [
    Hanzo AI,
...
## Integrate OpenRouter with Hanzo AI
...
Hanzo AI supports the OpenRouter API, allowing you to use models from various providers (Anthropic, Google,
...
Hanzo AI automatically use your default OpenRouter's available models. For custom configurations:
