---
title: OpenAI API
description: A step-by-step guide on integrating Hanzo AI with Azure OpenAI.
keywords:
  [
    Hanzo AI,
...
Hanzo AI supports most [OpenAI](https://openai.com/) as well as the many OpenAI-compatible APIs out there,
allowing you to use all models from OpenAI (GPT-4o, o3 and even those from Together AI, DeepSeek, Fireworks
and more) through Hanzo AI's interface.

## Integrate OpenAI API with Hanzo AI
...
Hanzo AI automatically includes popular OpenAI models. In case you want to use a specific model that you
cannot find in Hanzo AI, follow instructions in [Add Cloud Models](/docs/manage-models#add-models-1):
