---
title: Groq API
description: Learn how to integrate Groq API with Hanzo AI for enhanced functionality.
keywords:
  [
    Groq API,
    Hanzo AI,
...
Hanzo AI supports [Groq](https://groq.com/) API integration, allowing you to use Groq's high-performance LLM models (LLaMA 2, Mixtral and more) through Hanzo AI's interface.

## Integrate Groq API with Hanzo AI
...
Hanzo AI automatically includes Groq's available models. In case you want to use a specific Groq model that
you cannot find in **Hanzo AI**, follow the instructions in the [Add Cloud Models](/docs/manage-models#add-models-1):
