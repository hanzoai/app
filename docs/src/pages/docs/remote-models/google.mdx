---
title: Google
description: Learn how to integrate Google with Hanzo AI for enhanced functionality.
keywords:
  [
    Anthropic API,
    Hanzo AI,
...
Hanzo AI supports [Google](https://ai.google/get-started/our-models/) API integration, allowing you to use Google models (like Gemini series) through Hanzo AI's interface.

## Integrate Google API with Hanzo AI
...
Hanzo AI automatically includes Google's available models like Gemini series. In case you want to use a specific
Gemini model that you cannot find in **Hanzo AI**, follow instructions in [Add Cloud Models](/docs/manage-models#add-models-1):
