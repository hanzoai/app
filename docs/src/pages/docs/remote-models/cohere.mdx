---
title: Cohere
description: Learn how to integrate Cohere with Hanzo AI for enhanced functionality.
keywords:
  [
    Cohere API,
    Hanzo AI,
...
Hanzo AI supports [Cohere](https://cohere.com/) API integration, allowing you to use Cohere's
models (Command, Command-R and more) through Hanzo AI's interface.

## Integrate Cohere API with Hanzo AI
...
Hanzo AI automatically includes Cohere's available models. In case you want to use a specific
Cohere model that you cannot find in **Hanzo AI**, follow instructions in [Add Cloud Models](/docs/manage-models):
