---
title: Anthropic
description: Learn how to integrate Anthropic with Hanzo AI for enhanced functionality.
keywords:
  [
    Anthropic API,
    Hanzo AI,
...
Hanzo AI supports all of [Anthropic's models](https://anthropic.com/) via API integration, allowing
you to chat with Claude's latest Opus, Sonnet and Haiku models.

## Integrate Anthropic API with Hanzo AI
...
Hanzo AI automatically includes Anthropic's available models. In case you want to use a specific Anthropic model
that you cannot find in **Hanzo AI**, follow instructions in [Add Cloud Models](/docs/manage-models#add-models-1):
