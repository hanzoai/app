---
title: Hanzo AI Nano 32k
description: Hanzo AI-Nano-Gguf Model
keywords:
  [
    Hanzo AI,
    Hanzo AI Models,
...
![Hanzo AI Nano](../_assets/hanzo-nano0.png)

## Why Hanzo AI Nano?

Most language models face a fundamental tradeoff where powerful capabilities require a lot of computational resources. Hanzo AI 
...
## What is Hanzo AI Nano?

Hanzo AI Nano is a compact 4-billion parameter language model specifically designed and trained for deep research tasks. 
...
The model and its different model variants are fully supported by Hanzo AI.

<Callout type="info">
  To use Hanzo AI-Nano, you will need to use a search engine via MCP. You can enable MCP in the **Settings** 
...
## Using Hanzo AI-Nano-32k

**Step 1**
Download Hanzo AI from [here](https://hanzo.ai/docs/desktop/).

**Step 2**
Go to the Hub Tab, search for Hanzo AI-Nano-Gguf, and click on the download button to the best model size for your system.

![Hanzo AI Nano](../_assets/hanzo-nano1.png)

**Step 3**
Go to **Settings** > **Model Providers** > **Llama.cpp** click on the pencil icon and enable tool use for Hanzo AI-Nano-Gguf.

**Step 4**
To take advantage of Hanzo AI-Nano's full capabilities, you need to enable MCP support. We're going to use it with Serper's 
API. You can get a free API key from [here](https://serper.dev/). Sign up and they will immediately generate one for you.

**Step 5**
Add the serper MCP to Hanzo AI via the **Settings** > **MCP Servers** tab.

![Serper MCP](../_assets/serper-mcp.png)

**Step 6**
Open up a new chat and ask Hanzo AI-Nano to search the web for you.

![Hanzo AI Nano](../_assets/hanzo-nano-demo.gif)

## Queries to Try

Here are some example queries to showcase Hanzo AI-Nano's web search capabilities:
...
- What frontend should I use?
  - Hanzo AI Beta (recommended) - Minimalistic and polished interface
  - Download link: https://hanzo.ai/docs/desktop/beta
...
- Having model loading issues in Hanzo AI?
  - Use latest beta version: Hanzo AI-beta_0.5.18-rc6-beta
  - Ensure proper CUDA support for your GPU
  - Check VRAM requirements match your quantization choice

## Resources

- [Hanzo AI-Nano Model on Hugging Face](https://huggingface.co/hanzoai/Hanzo AI-nano)
- [Hanzo AI-Nano GGUF on Hugging Face](https://huggingface.co/hanzoai/Hanzo AI-nano-gguf)
