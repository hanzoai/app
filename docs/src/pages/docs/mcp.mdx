...
# Using the Model Context Protocol (MCP) in Hanzo AI

```mermaid
graph TD
    subgraph "What is MCP?"
        You[You using Hanzo AI Desktop]
        Claude[Hanzo AI AI Assistant]
...
Hanzo AI now supports the **Model Context Protocol (MCP)**, an open standard designed to allow language models to
...
Hanzo AI is an MCP host that allows you to download different clients and servers and use them to accomplish a task.

This document outlines the benefits, risks, and implementation of MCPs within Hanzo AI.

## Core Benefits of MCP

Integrating MCP provides a structured way to extend the capabilities of the models you use in Hanzo AI. Here are the three
...
<Callout type="warning">
  Please note that not all models that you can download and use, whether in Hanzo AI or other tools, may be good at
...
tool or a malicious prompt could potentially lead to unintended actions or data exposure. Hanzo AI's implementation
...
## Configure and Use MCPs within Hanzo AI

To illustrate how MCPs can be used within Hanzo AI, we will walk through an example using the [Browser MCP](https://browsermcp.io/).

Before we begin, you will need to enable Hanzo AI's MCP functionality at `Settings` > `MCP Servers`, and toggle
...
- Go back to Hanzo AI and pick a model with good tool use capabilities, for example, Claude 3.7 and 4 Sonnet, or Claude 4 Opus,
...
This integration is the foundation for creating more capable and context-aware AI assistants within Hanzo AI. The
...
local script toanalyze data and then summarize the findings, all orchestrated through Hanzo AI's interface. As
the MCP ecosystem grows, so will the potential applications within Hanzo AI.
