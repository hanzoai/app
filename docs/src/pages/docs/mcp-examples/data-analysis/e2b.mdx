...
The real value emerges when you combine secure remote execution with Hanzo AI's flexible model selection. You can use 
...
<Callout type="info">
Don't forget that MCP gets enabled once you turn on Experimental Features in Hanzo AI's General settings.
</Callout>
...
<Callout type="warning">
  As of `v0.6.5`, Hanzo AI won't be able to display visualizations in the chat but we're to get this fixed for the next release.
</Callout>
...
- Restart Hanzo AI if server won't start
