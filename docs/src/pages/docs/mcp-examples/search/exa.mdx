...
description: Connect Hanzo AI to real-time web search with Exa's AI-powered search engine.
keywords:
  [
    Hanzo AI,
    MCP,
...
- Hanzo AI with MCP enabled
- Exa API key from [dashboard.exa.ai](https://dashboard.exa.ai/api-keys)
- Model with tool calling support
- Node.js installed

<Callout type="info">
Tool calling support varies by model. Hanzo AI Nano 32k and 128k, Claude, Gemini, GPT-4o and above models work reliably. For both local and remote models, 
...
![Exa Hanzo AI MCP Server](../../_assets/exa1.png)

### Verify Setup

Check server status in the MCP Servers list.

![Exa Hanzo AI MCP Server](../../_assets/exa2.png)
...
- Try Hanzo AI Nano 32k, Claude, Gemini, GPT-4o and above models
...
Exa MCP enables real-time web search within Hanzo AI's privacy-focused environment. Models can access current information while maintaining 
