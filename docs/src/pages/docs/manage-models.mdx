...
This guide shows you how to add, customize, and delete models within Hanzo AI.
...
#### 1. Download from Hanzo AI Hub (Recommended)

The easiest way to get started is using Hanzo AI's built-in model hub (which is connected to [HuggingFace's Model Hub](https://huggingface.co/models):
1. Go to the **Hub** tab
...
<Callout type="info">
Hanzo AI will indicate if a model might be **Slow on your device** or **Not enough RAM** based on your system specifications.
</Callout>
...
4. In Hanzo AI, paste the model ID to the **Search** bar in **Hub** page
...
<br/>
**Paste it in Hanzo AI's Hub Search Bar.**
...
1. In Hanzo AI, go to **Settings > Model Providers > Llama.cpp**
...
3. Choose how you want to import:
  ...
  - **Duplicate:** Makes a copy of model files in Hanzo AI's directory
4. Click **Import** to complete (check the [Hanzo AI Data Folder](./data-folder) section for more info)
...
For advanced users who want to add a specific model that is not available within the Hanzo AI **Hub**:

<Steps>
##### Step 1: Create Model File
1. Navigate to the [Hanzo AI Data Folder](./data-folder)
...
Hanzo AI supports connecting to various AI cloud providers that are OpenAI API-compatible, including: OpenAI (GPT-4o, o3,...),
