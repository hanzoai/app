...
description: Understand and configure Hanzo AI's local AI engine for running models on your hardware.
keywords:
  [
    Hanzo AI,
...
Hanzo AI offers different backend versions optimized for your specific hardware. Think of these as different "drivers" - each one is tuned for particular processors or graphics cards.
...
**For most users:**
1. Use the default backend that Hanzo AI installs
...
<Callout type="info">
Most users can run Hanzo AI successfully without changing any of these settings. The defaults are chosen to work well on typical hardware.
</Callout>
