---
title: "Hanzo AI is faster now"
version: 0.5.4
description: "Hanzo AI has faster CPU inference."
date: 2024-09-17
ogImage: "/assets/images/changelog/hanzo-v0.5.4.jpg"
---

import ChangelogHeader from "@/components/Changelog/ChangelogHeader"

<ChangelogHeader title= "Hanzo AI is faster now" date="2024-09-01" ogImage= "/assets/images/changelog/hanzo-v0.5.4.jpg"  />

Over the last few weeks, we've been working on improving Hanzo AI's stability. Every update helps us make Hanzo AI's experience faster and smoother. 
...
For more details, see the [GitHub release notes](https://github.com/hanzoai/hanzo/releases/tag/v0.5.4).
