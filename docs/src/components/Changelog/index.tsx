  ...
  return (
    <div className="nextra-wrap-container">
      <div className="mt-14 text-center">
        ...
        <div className="text-black/60 dark:text-white/60">
          <p className="text-base mt-2 leading-relaxed">
            Latest release updates from the Hanzo AI team. Check out our&nbsp;
            <a
              href="https://github.com/orgs/hanzoai/projects/30"
                        ...
                        <div className="w-full pb-4 px-8 rounded-lg flex flex-col lg:flex-row justify-between">
                          <div>
                            ...
                            <p className="mt-2 text-black/60 dark:text-white/60 text-medium">
                              New release Hanzo AI App v{log?.version}
                            </p>
                          </div>
                        </div>
                      </div>
      ...
      <div className="text-center">
        <Link
          href="https://github.com/hanzoai/hanzo/releases"
          target="_blank"
