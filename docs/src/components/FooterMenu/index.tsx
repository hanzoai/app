...
export default function Footer() {
  useEffect(() => {
    if (typeof window !== 'undefined') {
      insights.init(process.env.INSIGHTS_KEY as string, {
        api_host: process.env.INSIGHTS_HOST || 'https://insights.hanzo.ai',
        disable_session_recording: true,
        person_profiles: 'always',
        persistence: 'localStorage',
      })

      insights.capture('web_page_view', { timestamp: new Date() })
    }
  }, [])
