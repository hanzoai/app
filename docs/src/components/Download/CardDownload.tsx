...
const systemsTemplate: SystemType[] = [
  {
    ...
    label: 'Universal',
    logo: FaApple,
    fileFormat: 'Hanzo AI_{tag}_universal.dmg',
  },
  {
    name: 'Windows',
    label: 'Standard (64-bit)',
    logo: FaWindows,
    fileFormat: 'Hanzo AI_{tag}_x64-setup.exe',
  },
  {
    name: 'Linux (AppImage)',
    label: 'AppImage',
    logo: FaLinux,
    fileFormat: 'Hanzo AI_{tag}_amd64.AppImage',
  },
  {
    name: 'Linux (deb)',
    label: 'Deb',
    logo: FaLinux,
    fileFormat: 'Hanzo AI_{tag}_amd64.deb',
  },
]
    ...
    const updateDownloadLinks = async () => {
      try {
        ...
        const updatedSystems = systems.map((system) => {
          ...
          return {
            ...system,
            href: `https://github.com/hanzoai/hanzo/releases/download/${lastRelease.tag_name}/${downloadUrl}`,
