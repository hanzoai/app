...
export const brandClasses = {
  ...
  gradient: {
    ...
    radial: "bg-gradient-radial from-[#fd4444]/15 via-[#ff6b6b]/5 to-transparent",
  },
  ...
  button: {
    ...
    gradient: "bg-gradient-to-r from-[#fd4444] to-[#ff6b6b] hover:from-[#e03e3e] hover:to-[#fd4444]",
  },
  ...
  badge: {
    ...
    gradient: "bg-gradient-to-r from-[#fd4444] to-[#ff6b6b] text-white border-0",
  },
