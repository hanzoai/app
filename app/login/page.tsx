    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex w-1/2 items-center justify-center px-6 py-20 bg-gradient-to-br from-neutral-900 via-black to-neutral-900 relative overflow-hidden">
          ...
          <div className="absolute top-1/4 -right-32 w-96 h-96 bg-white/5 rounded-full blur-3xl animate-pulse" />
          <div
            className="absolute bottom-1/4 -left-32 w-96 h-96 bg-white/5 rounded-full blur-3xl animate-pulse"
          ...
          <div className="relative z-10 max-w-xl w-full">
            ...
            <div className="bg-white/[0.03] backdrop-blur-sm rounded-2xl border border-white/[0.08] p-6">
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-white/60 rounded-full mt-2 animate-pulse" />
                <div className="flex-1">
                  <p className="text-white/30 text-xs uppercase tracking-wider mb-3">Try something like</p>
                  <div className="min-h-[60px]">
                    <p
                      className={`text-xl text-white/90 transition-all duration-500 font-light ${isTyping ? 'opacity-100' : 'opacity-0'}`}
                    >
                      {ideas[currentIdea]}
              ...
              <div className="mt-6 pt-6 border-t border-white/[0.06]">
                <div className="flex items-center justify-end">
                  <div className="flex items-center gap-2 px-5 py-2.5 bg-white text-black rounded-xl font-medium text-sm">
