        ...
        try {
          ...
          sendProgress({
            ...
            details: {
              ...
              updateReady: true,
              changelog,
              compareUrl: `https://github.com/hanzoai/app/compare/${currentCommit.trim().substring(0, 7)}...${remoteCommit.trim().substring(0, 7)}`,
            },
          });
