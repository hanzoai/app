    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="px-4 md:px-8 py-16 md:py-24 text-center">
        <div className="max-w-4xl mx-auto">
          <Badge className="mb-4 bg-gradient-to-r from-[#171717] to-[#404040] text-white border-0">
          ...
          <div className="flex items-center gap-4 justify-center">
            <Button size="lg" className="bg-gradient-to-r from-[#171717] to-[#404040] hover:from-[#000000] hover:to-[#171717]">
              Share Your Project
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProjects.map(project => (
              <div key={project.id} className="bg-[#1a1a1a] rounded-2xl border border-white/10 hover:border-[#171717]/50 transition-all overflow-hidden group">
                {project.featured && (
                  <div className="bg-gradient-to-r from-[#171717] to-[#404040] text-white text-xs px-3 py-1.5 flex items-center gap-1">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#171717] to-[#404040] flex items-center justify-center">
      ...
      {/* Top Contributors */}
      <section className="px-4 md:px-8 py-16 bg-gradient-to-b from-transparent via-[#171717]/10 to-transparent">
        <div className="max-w-7xl mx-auto">
