...
export const URL_CONFIGURABLE_PROVIDERS = ['Ollama', 'LMStudio', 'OpenAI'];
export const LOCAL_PROVIDERS = ['OpenAI', 'LMStudio', 'Ollama'];
...
const getInitialTabConfiguration = (): TabWindowConfig => {
  ...
  try {
    const saved = localStorage.getItem('hanzo_tab_configuration');
...
export const resetTabConfiguration = () => {
  ...
  localStorage.setItem('hanzo_tab_configuration', JSON.stringify(defaultConfig));
};
