      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <h3 className="text-base font-medium text-hanzo-elements-textPrimary">Netlify Connection</h3>
          </div>
        </div>
        ...
        {!connection.user ? (
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-hanzo-elements-textSecondary mb-2">Personal Access Token</label>
              <input
                type="password"
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 bg-[#F8F8F8] dark:bg-[#1A1A1A] rounded-lg">
              ...
              />
              <div>
                <h4 className="text-sm font-medium text-hanzo-elements-textPrimary">{connection.user.full_name}</h4>
                <p className="text-sm text-hanzo-elements-textSecondary">{connection.user.email}</p>
              </div>
            </div>

            {fetchingStats ? (
              <div className="flex items-center gap-2 text-sm text-hanzo-elements-textSecondary">
              ...
              <div>
                <button
                  ...
                  className="w-full bg-transparent text-left text-sm font-medium text-hanzo-elements-textPrimary mb-3 flex items-center gap-2"
                >
                ...
                {isSitesExpanded && connection.stats?.sites?.length ? (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          {site.build_settings?.provider && (
                            <div className="text-xs text-hanzo-elements-textSecondary px-2 py-1 rounded-md bg-[#F0F0F0] dark:bg-[#252525]">
                              <span className="flex items-center gap-1">
                  ...
                  <div className="text-sm text-hanzo-elements-textSecondary flex items-center gap-2">
