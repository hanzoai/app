    ...
    >
      <div className="p-6 space-y-6">
        <div className="flex items-center gap-2">
          <div className="i-ph:github-logo w-5 h-5 text-hanzo-elements-textPrimary" />
          <h3 className="text-base font-medium text-hanzo-elements-textPrimary">GitHub Connection</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-hanzo-elements-textSecondary mb-2">Token Type</label>
            <select
          ...
          <div>
            ...
            <input
              ...
              className={classNames(
                ...
                'bg-[#F8F8F8] dark:bg-[#1A1A1A]',
                'border border-[#E5E5E5] dark:border-[#333333]',
                'text-hanzo-elements-textPrimary placeholder-hanzo-elements-textTertiary',
                'focus:outline-none focus:ring-1 focus:ring-purple-500',
                'disabled:opacity-50',
              )}
            />
            <div className="mt-2 text-sm text-hanzo-elements-textSecondary">
              <a
        ...
        <div className="flex items-center gap-3">
          ...
          {connection.user && (
            <span className="text-sm text-hanzo-elements-textSecondary flex items-center gap-1">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-medium text-hanzo-elements-textPrimary">
                      {connection.user.name || connection.user.login}
                    </h3>
                    <div
                      className={classNames(
                        'i-ph:caret-down w-4 h-4 text-hanzo-elements-textSecondary transition-transform',
                        isStatsExpanded ? 'rotate-180' : '',
                      )}
                    />
                  </div>
                  {connection.user.bio && (
                    <p className="text-sm text-start text-hanzo-elements-textSecondary">{connection.user.bio}</p>
                  )}
                  <div className="flex gap-4 mt-2 text-sm text-hanzo-elements-textSecondary">
            ...
            {isStatsExpanded && (
              <div className="pt-4">
                {connection.stats.organizations.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-hanzo-elements-textPrimary mb-3">Organizations</h4>
                    <div className="flex flex-wrap gap-3">
                      {connection.stats.organizations.map((org) => (
                        ...
                        >
                          ...
                          <span className="text-sm text-hanzo-elements-textPrimary">{org.login}</span>
                        </a>
                      ))}
                    </div>
                  </div>
                ...
                {/* Languages Section */}
                <div className="mb-6">
                  <h4 className="text-sm font-medium text-hanzo-elements-textPrimary mb-3">Top Languages</h4>
                ...
                <div className="mb-6">
                  <h4 className="text-sm font-medium text-hanzo-elements-textPrimary mb-3">Recent Activity</h4>
                  <div className="space-y-3">
                    {connection.stats.recentActivity.map((event) => (
                      <div key={event.id} className="p-3 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A] text-sm">
                        <div className="flex items-center gap-2 text-hanzo-elements-textPrimary">
                          <div className="i-ph:git-commit w-4 h-4 text-hanzo-elements-textSecondary" />
                        ...
                        <div className="mt-1 text-xs text-hanzo-elements-textSecondary">
                ...
                <div className="grid grid-cols-4 gap-4 mb-6">
                  <div className="p-4 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A]">
                    <div className="text-sm text-hanzo-elements-textSecondary">Member Since</div>
                    <div className="text-lg font-medium text-hanzo-elements-textPrimary">
                      {new Date(connection.user.created_at).toLocaleDateString()}
                    </div>
                  </div>
                  <div className="p-4 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A]">
                    <div className="text-sm text-hanzo-elements-textSecondary">Public Gists</div>
                    <div className="text-lg font-medium text-hanzo-elements-textPrimary">
                      {connection.stats.totalGists}
                    </div>
                  </div>
                  <div className="p-4 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A]">
                    <div className="text-sm text-hanzo-elements-textSecondary">Organizations</div>
                    <div className="text-lg font-medium text-hanzo-elements-textPrimary">
                      {connection.stats.organizations.length}
                    </div>
                  </div>
                  <div className="p-4 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A]">
                    <div className="text-sm text-hanzo-elements-textSecondary">Languages</div>
                    <div className="text-lg font-medium text-hanzo-elements-textPrimary">
                ...
                <h4 className="text-sm font-medium text-hanzo-elements-textPrimary mb-3">Recent Repositories</h4>
                <div className="space-y-3">
                  {connection.stats.repos.map((repo) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <h5 className="text-sm font-medium text-hanzo-elements-textPrimary flex items-center gap-2">
                            <div className="i-ph:git-repository w-4 h-4 text-hanzo-elements-textSecondary" />
                            {repo.name}
                          </h5>
                          {repo.description && (
                            <p className="text-xs text-hanzo-elements-textSecondary mt-1">{repo.description}</p>
                          )}
                          <div className="flex items-center gap-2 mt-2 text-xs text-hanzo-elements-textSecondary">
                            <span className="flex items-center gap-1">
                        ...
                        <div className="flex items-center gap-3 text-xs text-hanzo-elements-textSecondary">
                          <span className="flex items-center gap-1">
  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-hanzo-elements-textSecondary">Loading...</span>
      </div>
    </div>
  );
}
