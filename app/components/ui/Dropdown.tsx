  ...
  return (
    <div className="relative">
      <button
        ...
        className="whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:bg-blue-500 hover:text-white rounded-md ml-auto flex h-fit items-center justify-center gap-1 px-1 py-0.5 focus-visible:ring-0"
        type="button"
      ...
      {isOpen && (
        <div className="absolute mt-2 w-48 bg-hanzo-elements-background-depth-2 text-white rounded-md shadow-lg">
          <div className="p-2">
          ...
          <div className="p-2">
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 -960 960 960" className="shrink-0 h-4 w-4 text-muted-foreground" fill="currentColor"><path d="M220-80q-24.75 0-42.37-17.63Q160-115.25 160-140v-434q0-24.75 17.63-42.38Q195.25-634 220-634h70v-96q0-78.85 55.61-134.42Q401.21-920 480.11-920q78.89 0 134.39 55.58Q670-808.85 670-730v96h70q24.75 0 42.38 17.62Q800-598.75 800-574v434q0 24.75-17.62 42.37Q764.75-80 740-80zm0-60h520v-434H220zm260.17-140q31.83 0 54.33-22.03T557-355q0-30-22.67-54.5t-54.5-24.5-54.33 24.5-22.5 55 22.67 52.5 54.5 22M350-634h260v-96q0-54.17-37.88-92.08-37.88-37.92-92-37.92T388-822.08q-38 37.91-38 92.08zM220-140v-434z"></path></svg>
              Private
            </label>
