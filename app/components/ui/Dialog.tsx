  ...
  return (
    <RadixDialog.Title
      className={classNames(
        'text-lg font-medium text-hanzo-elements-textPrimary',
...
export const DialogDescription = memo(({ className, children, ...props }: RadixDialog.DialogDescriptionProps) => {
  return (
    <RadixDialog.Description
      className={classNames('text-sm text-hanzo-elements-textSecondary', 'mt-1', className)}
      {...props}
    >
      {children}
    </RadixDialog.Description>
          ...
          <div className="flex flex-col">
            ...
            {showCloseButton && (
              <RadixDialog.Close asChild onClick={onClose}>
                <IconButton
                  icon="i-ph:x"
                  className="absolute top-3 right-3 text-hanzo-elements-textSecondary hover:text-hanzo-elements-textPrimary"
                />
              </RadixDialog.Close>
            )}
          </div>
