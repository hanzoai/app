  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-hanzo-elements-borderColor bg-hanzo-elements-background-depth-1 text-hanzo-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-hanzo-elements-textSecondary', className)} {...props} />;
  },
);
