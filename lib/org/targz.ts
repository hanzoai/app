/**
 * Pure-Node tar.gz builder (no external deps) for the projects service deploy artifact.
 *
 * The cloud projects service `/deploy` endpoint accepts a tar or tar.gz of the BUILT
