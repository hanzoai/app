...
const securityHeaders = {
  ...
  'Content-Security-Policy': [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://*.stripe.com https://*.huggingface.co",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    "font-src 'self' https://fonts.gstatic.com data:",
    "img-src 'self' data: blob: https: http:",
    "media-src 'self' blob: data:",
    "connect-src 'self' https://*.huggingface.co https://*.stripe.com https://api.openai.com https://api.anthropic.com wss://*.huggingface.co",
    "frame-src 'self' https://*.stripe.com https://*.huggingface.co",
...
const devSecurityHeaders = {
  ...
  'Content-Security-Policy': [
    ...
    "media-src 'self' blob: data:",
    "connect-src 'self' http://localhost:* ws://localhost:* wss://localhost:* https://*.huggingface.co https://*.stripe.com",
